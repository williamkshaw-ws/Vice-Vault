...
export default function AddMissingBallForm({ 
  ...
  const [customImageSleeve, setCustomImageSleeve] = useState<string | null | undefined>(undefined);
  const [customImageBox, setCustomImageBox] = useState<string | null | undefined>(undefined);
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="grid grid-cols-3 gap-3">
              {/* Ball Image */}
              <div 
                onClick={() => { if (!customImage) ballInputRef.current?.click(); }}
              ...
              {/* Sleeve Image */}
              <div 
                onClick={() => { if (!customImageSleeve) sleeveInputRef.current?.click(); }}
                className={`relative border border-dashed rounded-xl p-2.5 flex flex-col items-center justify-center gap-1 cursor-pointer h-16 text-center transition-all ${
              ...
              {/* Box Image */}
              <div 
                onClick={() => { if (!customImageBox) boxInputRef.current?.click(); }}
                className={`relative border border-dashed rounded-xl p-2.5 flex flex-col items-center justify-center gap-1 cursor-pointer h-16 text-center transition-all ${
