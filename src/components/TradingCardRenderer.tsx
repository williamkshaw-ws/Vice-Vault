        ...
        >
          ...
          <div className="flex justify-between items-start mb-6 z-10 shrink-0">
            ...
            <div className="w-11 h-11 rounded-full border-2 border-[#cca300] relative shrink-0">
              <span className="absolute top-[8px] left-[13px] text-[#cca300] font-black text-xl font-serif leading-none">G</span>
            </div>
          </div>
          ...
          <div className="z-10 shrink-0 min-w-0 flex flex-col justify-end">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-3">
                ...
                <span className="block text-[15px] text-white font-black leading-normal pb-1 pt-[2px]">{ball.color}</span>
              </div>
              <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-3">
                <span className="block text-[10px] text-neutral-500 font-bold tracking-widest uppercase mb-1">Condition</span>
                <span className="block text-[15px] text-white font-black leading-normal pb-1 pt-[2px]">{ball.condition}</span>
              </div>
              <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-3">
                <span className="block text-[10px] text-neutral-500 font-bold tracking-widest uppercase mb-1">Variation</span>
                <span className="block text-[15px] text-white font-black leading-normal pb-1 pt-[2px] truncate">{ball.variation || catalogItem?.variation || "-"}</span>
              </div>
              <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-3">
                <span className="block text-[10px] text-neutral-500 font-bold tracking-widest uppercase mb-1">Year</span>
                <span className="block text-[15px] text-white font-black leading-normal pb-1 pt-[2px]">{ball.year || catalogItem?.year || "-"}</span>
              </div>
            </div>
