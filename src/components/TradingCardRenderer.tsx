      ...
      <div className={`${isDarkTheme ? "dark" : ""} fixed top-0 left-0 opacity-0 pointer-events-none z-[-9999]`}>
        ...
        >
          ...
          <div className="flex justify-between items-start mb-6 z-10 shrink-0">
            ...
            {/* Authenticity Stamp */}
            <div className="w-11 h-11 rounded-full border-2 border-[#cca300] relative shrink-0">
              <span className="absolute top-[0px] left-[11.5px] text-[#cca300] font-black text-xl font-serif leading-none">G</span>
            </div>
          </div>
          ...
          <div className="z-10 shrink-0 min-w-0 flex flex-col justify-end">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-3">
                <span className="block text-[10px] text-neutral-500 font-bold tracking-widest uppercase">Color</span>
                <span className="block text-[15px] text-white font-black leading-normal pb-[6px] relative -top-[2px]">{ball.color}</span>
              </div>
              <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-3">
                <span className="block text-[10px] text-neutral-500 font-bold tracking-widest uppercase">Condition</span>
                <span className="block text-[15px] text-white font-black leading-normal pb-[6px] relative -top-[2px]">{ball.condition}</span>
              </div>
              <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-3">
                <span className="block text-[10px] text-neutral-500 font-bold tracking-widest uppercase">Variation</span>
                <span className="block text-[15px] text-white font-black leading-normal pb-[6px] relative -top-[2px] truncate">{ball.variation || catalogItem?.variation || "-"}</span>
              </div>
              <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-3">
                <span className="block text-[10px] text-neutral-500 font-bold tracking-widest uppercase">Year</span>
                <span className="block text-[15px] text-white font-black leading-normal pb-[6px] relative -top-[2px]">{ball.year || catalogItem?.year || "-"}</span>
              </div>
            </div>
